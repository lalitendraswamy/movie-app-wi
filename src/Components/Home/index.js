...
class Home extends Component{
    ...
    getMovies=async()=>{
        ...
        const response = await fetch(`https://api.themoviedb.org/3/movie/popular?api_key=0e4cbd4813aa6ef290ad76141eaeda85&language=en-US&page=1&language=en-US&page=1`);
